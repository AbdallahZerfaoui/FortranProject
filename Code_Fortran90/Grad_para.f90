...
!============================================
	...
	integer::compt=0,l,Me,i1,ie, statinfo, Np
...
!==============================
!Communication des blocs de Nx suivants la partie concern� 
...
!Communication des blocs de Nx pr�c�dents la partie concern� 
!sauf en pour Me=0	
	if (Me>0) then 	
...
! Calcul de alpha
!==============================
!Calcul de la partie numerateur	
...
!Envoi et sommation des parties denominateurs de chaque processeur
...
! Calcul de beta
!==============================
!Calcul de la partie num�rateur
beta_me_num = dot_product(Gr(i1:ie),Gr(i1:ie))
!Calcul de la partie d�nominateur
...
!Envoie et sommation des parties d�nominateurs de chaque processeur
